...
export class AccountClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    verifyPhoneNo(userId, phoneNo, token, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processVerifyPhoneNo(_response));
        });
    }
    processVerifyPhoneNo(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    get2FAProviders(userId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGet2FAProviders(_response));
        });
    }
    processGet2FAProviders(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    verify2FAToken(userId, provider, token, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processVerify2FAToken(_response));
        });
    }
    processVerify2FAToken(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    enable2FA(userId, provider, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processEnable2FA(_response));
        });
    }
    processEnable2FA(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    disable2FA(userId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processDisable2FA(_response));
        });
    }
    processDisable2FA(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    getAuthenticatorUrl(userId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGetAuthenticatorUrl(_response));
        });
    }
    processGetAuthenticatorUrl(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    generateAuthenticatorKey(userId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGenerateAuthenticatorKey(_response));
        });
    }
    processGenerateAuthenticatorKey(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class AuditClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    getAll(userId, groupId, entity, entityId, from, to, x_Api_Version) {
...
export class ClassesClient extends AIForgedBase {
     ...
     * @return List of classes
     */
    findByName(projectId, name, lookupMethod, minConfidence, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processFindByName(_response));
        });
    }
    processFindByName(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class DataSetClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    get(docId, defId, includeData, pageNo, pageSize, sortFieldDefId, sortDirection, searchField, searchFilter, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    getByName(projectId, stpdId, dataSetName, includeData, pageNo, pageSize, sortFieldDefId, sortDirection, searchField, searchFilter, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    getByDef(projectId, stpdId, pdId, includeData, pageNo, pageSize, sortFieldDefId, sortDirection, searchField, searchFilter, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    getById(dataSetId, includeData, pageNo, pageSize, sortFieldDefId, sortDirection, searchField, searchFilter, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    updateRecord(docId, defId, x_Api_Version, record) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processUpdateRecord(_response));
        });
    }
    processUpdateRecord(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    sync(projectId, stpdId, pdId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processSync(_response));
        });
    }
...
export class DocumentClient extends AIForgedBase {
     ...
     */
    unDelete(id, newstatus, usagefilter, recursive, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processUnDelete(_response));
        });
    }
    processUnDelete(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param x_Api_Version (optional)
     */
    getSystemDocuments(pattern, filetype, contenttype, statuses, masterId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGetSystemDocuments(_response));
        });
    }
    processGetSystemDocuments(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    deletePages(id, childUsage, childStatus, childDeleteOptions, x_Api_Version, pageIndexes) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processDeletePages(_response));
        });
    }
    processDeletePages(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    deleteFieldsOnPage(id, pageIndex, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processDeleteFieldsOnPage(_response));
        });
    }
    processDeleteFieldsOnPage(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    changeFieldPageIndex(id, fromPageIndex, toPageIndex, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processChangeFieldPageIndex(_response));
        });
    }
    processChangeFieldPageIndex(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    setFieldPageVerificationIndex(id, fromPageIndex, toPageIndex, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processSetFieldPageVerificationIndex(_response));
        });
    }
    processSetFieldPageVerificationIndex(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    getTrainingReport(id, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGetTrainingReport(_response));
        });
    }
    processGetTrainingReport(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return The result
     */
    fixPageVerificationIndex(id, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processFixPageVerificationIndex(_response));
        });
    }
    processFixPageVerificationIndex(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @param data (optional)
     */
    upload(stpdId, userId, projectId, classId, status, usage, masterid, comment, externalId, result, resultId, resultIndex, guid, x_Api_Version, data) {
     ...
     * @param x_Api_Version (optional)
     */
    store(stpdId, userId, projectId, masterid, x_Api_Version, docs) {
     ...
     * @return The document
     */
    classify(stpdId, projectId, masterId, comment, externalId, result, resultId, resultIndex, guid, x_Api_Version, file) {
     ...
     * @return The document
     */
    extractAndVerify(stpdId, projectId, masterId, comment, externalId, result, resultId, resultIndex, guid, x_Api_Version, file) {
...
export class LogClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    getAll(projectId, serviceId, documentId, defId, parameterId, verId, workitemId, userId, x_Api_Version) {
...
export class MarketPlaceClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    linkUsers(userId, projectId, serviceId, groupId, type, otherUserIds, role, permission, x_Api_Version) {
...
export class NotificationClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    getAttachment(id, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    create(x_Api_Version, notification) {
...
export class ParamDefClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    getUsageCount(projectId, stpdId, pdId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processGetUsageCount(_response));
        });
    }
    processGetUsageCount(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class ParametersClient extends AIForgedBase {
     ...
     */
    getHierarchy(docId, stpdId, includeverification, pageIndex, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    bulkChangeParamDef(projectId, pdIdFrom, pdIdTo, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processBulkChangeParamDef(_response));
        });
    }
    processBulkChangeParamDef(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
     ...
     * @return Flat structure of document parameters
     */
    exportToExcel(projectId, serviceId, fromDate, toDate, pageNo, pageSize, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processExportToExcel(_response));
        });
    }
    processExportToExcel(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class ProjectClient extends AIForgedBase {
     ...
     */
    getHierachies(userId, projectId, stpdId, groupId, includeCount, onlyServices, includeSettings, includeChildren, x_Api_Version) {
...
export class ServicesClient extends AIForgedBase {
     ...
     * @return The result
     */
    getTrainingReport(projectId, stpdId, classId, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    process(userId, projectId, stpdId, documentIds, force, deleteChildDocs, deleteChildDocsRecursive, deletePreviousOutputDocs, resetResults, resetComments, resumeIdentifier, queueProcessing, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    changeServiceType(userId, projectId, stpdId, stId, x_Api_Version) {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response) => this.processChangeServiceType(_response));
        });
    }
    processChangeServiceType(response) {
        const status = response.status;
        let _headers = {};
        if (response.headers && response.headers.forEach) {
            response.headers.forEach((v, k) => _headers[k] = v);
...
export class WizardClient extends AIForgedBase {
     ...
     * @param x_Api_Version (optional)
     */
    getAll(projectId, stpdId, validate, x_Api_Version) {
     ...
     * @param x_Api_Version (optional)
     */
    validate(projectId, type, x_Api_Version, wizard) {
...
export class WorkItemClient extends AIForgedBase {
     ...
     */
    create(docId, shredId, comment, method, graceperiod, toUserId, x_Api_Version, roles) {
...
export class AuditViewModel {
    ...
    init(_data) {
        if (_data) {
            ...
            this.parameter = _data["parameter"] ? DocumentParameterViewModel.fromJS(_data["parameter"]) : undefined;
            this.verification = _data["verification"] ? VerificationViewModel.fromJS(_data["verification"]) : undefined;
            this.workItem = _data["workItem"] ? WorkItemViewModel.fromJS(_data["workItem"]) : undefined;
            this.transaction = _data["transaction"] ? TransactionsAuditViewModel.fromJS(_data["transaction"]) : undefined;
            this.event = _data["event"] ? ServiceEventViewModel.fromJS(_data["event"]) : undefined;
            this.userName = _data["userName"];
    ...
    toJSON(data) {
        ...
        data["parameter"] = this.parameter ? this.parameter.toJSON() : undefined;
        data["verification"] = this.verification ? this.verification.toJSON() : undefined;
        data["workItem"] = this.workItem ? this.workItem.toJSON() : undefined;
        data["transaction"] = this.transaction ? this.transaction.toJSON() : undefined;
...
export var AuditEntity;
(function (AuditEntity) {
    AuditEntity[AuditEntity["Project"] = 0] = "Project";
    AuditEntity[AuditEntity["Service"] = 1] = "Service";
    AuditEntity[AuditEntity["Document"] = 2] = "Document";
    AuditEntity[AuditEntity["Work"] = 3] = "Work";
    AuditEntity[AuditEntity["Contact"] = 4] = "Contact";
    AuditEntity[AuditEntity["Notification"] = 5] = "Notification";
    AuditEntity[AuditEntity["Payment"] = 6] = "Payment";
    AuditEntity[AuditEntity["Verification"] = 7] = "Verification";
    AuditEntity[AuditEntity["DataSet"] = 8] = "DataSet";
    AuditEntity[AuditEntity["Reports"] = 9] = "Reports";
    AuditEntity[AuditEntity["Group"] = 10] = "Group";
    AuditEntity[AuditEntity["ParamDef"] = 11] = "ParamDef";
    AuditEntity[AuditEntity["Parameter"] = 12] = "Parameter";
    AuditEntity[AuditEntity["Audit"] = 13] = "Audit";
})(AuditEntity || (AuditEntity = {}));
export var AuditAccessType;
(function (AuditAccessType) {
    AuditAccessType[AuditAccessType["Create"] = 0] = "Create";
    AuditAccessType[AuditAccessType["Read"] = 1] = "Read";
    AuditAccessType[AuditAccessType["Update"] = 2] = "Update";
    AuditAccessType[AuditAccessType["Delete"] = 3] = "Delete";
    AuditAccessType[AuditAccessType["Move"] = 4] = "Move";
    AuditAccessType[AuditAccessType["Copy"] = 5] = "Copy";
    AuditAccessType[AuditAccessType["Clone"] = 6] = "Clone";
    AuditAccessType[AuditAccessType["Elevate"] = 7] = "Elevate";
    AuditAccessType[AuditAccessType["Work"] = 8] = "Work";
    AuditAccessType[AuditAccessType["Init"] = 9] = "Init";
    AuditAccessType[AuditAccessType["Train"] = 10] = "Train";
    AuditAccessType[AuditAccessType["Process"] = 11] = "Process";
    AuditAccessType[AuditAccessType["UnDelete"] = 12] = "UnDelete";
...
(function (Availability) {
    ...
    Availability[Availability["Readonly"] = 10] = "Readonly";
...
(function (DocumentStatus) {
    ...
    DocumentStatus[DocumentStatus["Queued"] = 11] = "Queued";
    DocumentStatus[DocumentStatus["Verifying"] = 12] = "Verifying";
    DocumentStatus[DocumentStatus["InsufficientBalance"] = 81] = "InsufficientBalance";
    DocumentStatus[DocumentStatus["Error"] = 90] = "Error";
    DocumentStatus[DocumentStatus["Archive"] = 98] = "Archive";
...
(function (CategoryStatus) {
    CategoryStatus[CategoryStatus["Enabled"] = 0] = "Enabled";
    CategoryStatus[CategoryStatus["Disabled"] = 1] = "Disabled";
    CategoryStatus[CategoryStatus["Deleted"] = 99] = "Deleted";
})(CategoryStatus || (CategoryStatus = {}));
export var DictionaryLookupMethod;
(function (DictionaryLookupMethod) {
    DictionaryLookupMethod[DictionaryLookupMethod["Exact"] = 0] = "Exact";
    DictionaryLookupMethod[DictionaryLookupMethod["LevenshteinDistance"] = 1] = "LevenshteinDistance";
    DictionaryLookupMethod[DictionaryLookupMethod["HammingDistance"] = 2] = "HammingDistance";
    DictionaryLookupMethod[DictionaryLookupMethod["RegEx"] = 3] = "RegEx";
...
export var OperationOption;
(function (OperationOption) {
    OperationOption[OperationOption["None"] = 0] = "None";
    OperationOption[OperationOption["All"] = 1] = "All";
...
(function (RatingType) {
    RatingType[RatingType["User"] = 0] = "User";
    RatingType[RatingType["Agerage"] = 1] = "Agerage";
    RatingType[RatingType["Error"] = 99] = "Error";
})(RatingType || (RatingType = {}));
export var RatingStatus;
(function (RatingStatus) {
    RatingStatus[RatingStatus["Enabled"] = 0] = "Enabled";
    RatingStatus[RatingStatus["Disabled"] = 1] = "Disabled";
...
(function (NotificationEvent) {
    ...
    NotificationEvent[NotificationEvent["UnDelete"] = 16777216] = "UnDelete";
...
export class User {
    ...
    init(_data) {
        if (_data) {
            ...
            this.profile = _data["profile"] ? ServicePrincipalProfile.fromJS(_data["profile"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
...
export class SubscriptionUser extends User {
    constructor(data) {
        super(data);
    }
    init(_data) {
...
(function (EnumType) {
    ...
    EnumType[EnumType["CategoryStatus"] = 5] = "CategoryStatus";
    ...
    EnumType[EnumType["RatingStatus"] = 97] = "RatingStatus";
    EnumType[EnumType["UserGroupType"] = 100] = "UserGroupType";
    EnumType[EnumType["UserGroupStatus"] = 101] = "UserGroupStatus";
    EnumType[EnumType["LogType"] = 110] = "LogType";
    EnumType[EnumType["AuditEntity"] = 200] = "AuditEntity";
    EnumType[EnumType["AuditAccessType"] = 201] = "AuditAccessType";
...
export class BackgoundWorkItem {
    ...
    init(_data) {
        if (_data) {
            ...
            this.start = _data["start"] ? new Date(_data["start"].toString()) : undefined;
            this.end = _data["end"] ? new Date(_data["end"].toString()) : undefined;
            this.lastMsgDT = _data["lastMsgDT"] ? new Date(_data["lastMsgDT"].toString()) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data) {
        ...
        data["start"] = this.start ? this.start.toISOString() : undefined;
        data["end"] = this.end ? this.end.toISOString() : undefined;
        data["lastMsgDT"] = this.lastMsgDT ? this.lastMsgDT.toISOString() : undefined;
        return data;
    }
}
...
export var WizardValidation;
(function (WizardValidation) {
    WizardValidation[WizardValidation["NA"] = 0] = "NA";
    WizardValidation[WizardValidation["Steps"] = 1] = "Steps";
    WizardValidation[WizardValidation["Options"] = 2] = "Options";
    WizardValidation[WizardValidation["BeforeSave"] = 3] = "BeforeSave";
